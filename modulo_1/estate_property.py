...
class EstateProperty(models.Model):
    ...
    state = fields.Selection(string="Status", selection=[("new", "New"), ("offerReceived", "Offer Received"), ("offeraccepted", "Offer Accepted"), ("sold","Sold"), ("canceled", "Canceled")], default="sold", required=True, copy=False)
